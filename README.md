...
|:---:|:---|:---|:---:|
| 🧠 | **Claude API & Claude Code** | Agentic coding, prompt workflows, automation | `Anthropic` |
| 🔗 | **LangChain & LangGraph** | Multi-step AI chains & agent orchestration | `Agents` |
| 🗂️ | **RAG & Vector DBs** (Pinecone, ChromaDB) | Semantic search, intelligent document processing | `Retrieval` |
| 🖼️ | **AI Image Generation** (Stable Diffusion, Flux) | Automated ad creatives, visual content | `Creative` |
| ⚙️ | **OpenAI & Groq APIs** (GPT-4o, Llama 3) | Low-latency LLM inference | `LLMs` |
| 🔁 | **n8n & Make** | No-code + AI pipeline orchestration | `Automation` |
